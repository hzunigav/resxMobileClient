...
describe('ChatMessageUpdatePage', () => {
  let component: ChatMessageUpdatePage;
  let fixture: ComponentFixture<ChatMessageUpdatePage>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ChatMessageUpdatePage],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ChatMessageUpdatePage);
